...
# ------------------------------------------------------------------------------
    ...
    def init(self, timeStamp=0):
        print 'model_FUS_2_mcmd.init() called'

        if (self.services == None) :
            services.error('Error in model_FUS_2 init (): No self.services')
            raise Exception('Error in model_FUS_2 init (): No self.services')
    ...
    # Get global configuration parameters
        try:
            ...
            print 'model_FUS_2: error in getting config parameters'
            services.error('model_FUS_2: error in getting config parameters')
            raise Exception, 'model_FUS_2: error in getting config parameters'
    ...
    # later
        try:
            ...
            print 'model_FUS_2 init: error getting component-specific config parameters'
            services.error('model_FUS_2: error getting component-specific\
            config parameters')
            raise Exception, 'model_FUS_2: error getting model_epa-specific\
            config parameters'
    ...
    # Get input files  
        ...
        FUS_bin = os.path.join(BIN_PATH, 'model_FUS_2_mcmd')
...
# ------------------------------------------------------------------------------
    ...
    def restart(self, timeStamp):
      print 'model_FUS_2.restart() called'
    ...
    # Get restart files listed in config file.        
      try:
            ...
            self.services.error('model_FUS_2.restart: error in call to get_restart_files()')
            raise Exception, 'model_FUS_2.restart: error in call to get_restart_files()'
      return 0
...
# ------------------------------------------------------------------------------
    ...
    def step(self, timeStamp):
        print 'model_FUS_2_mcmd.step() called'
