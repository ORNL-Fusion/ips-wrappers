...
PROGRAM model_EPA_mdescr
  ...
  REAL(KIND=rspec) :: Te_0, Te_edge, alpha_Te_1, alpha_Te_2, alpha_Te_1a, alpha_Te_2a, fpro_Te
  REAL(KIND=rspec) :: ne_0, ne_edge, alpha_ne_1, alpha_ne_2, alpha_ne_1a, alpha_ne_2a, fpro_ne
  REAL(KIND=rspec) :: Ti_0, Ti_edge, alpha_Ti_1, alpha_Ti_2, alpha_Ti_1a, alpha_Ti_2a, fpro_Ti
  REAL(KIND=rspec) :: ni_0, ni_edge, alpha_ni_1, alpha_ni_2, alpha_ni_1a, alpha_ni_2a, fpro_ni
  ...
  namelist /evolving_model_data/ &
          ...
          Te_0, Te_edge, alpha_Te_1, alpha_Te_2,alpha_Te_1a, alpha_Te_2a, fpro_Te, &
          ne_0, ne_edge, alpha_ne_1, alpha_ne_2,alpha_ne_1a, alpha_ne_2a, fpro_ne, &
          Ti_profile_model_name, ni_profile_model_name, &
          Ti_0, Ti_edge, alpha_Ti_1, alpha_Ti_2,alpha_Ti_1a, alpha_Ti_2a, fpro_Ti, &
          ni_0, ni_edge, alpha_ni_1, alpha_ni_2,alpha_ni_1a, alpha_ni_2a, fpro_ni, &
          frac_ni, frac_Ti, &
          fracmin_T, fracmin_n, &
...
CONTAINS
    ...
    SUBROUTINE ACCOME_Parabolic(rho,fpro,p0,p1,p0a,p1a,f0,f_edge,f)
      !  ACCOME style parabolic profile generator, dimensional
       REAL(KIND=rspec), intent(in) :: fpro,p0,p1,p0a,p1a
       REAL(KIND=rspec), intent(in) :: f0,f_edge
       REAL(KIND=rspec), dimension(:), intent(in) :: rho  ! normalized sqrt tor. flux
       REAL(KIND=rspec), dimension(:), intent(out) :: f  ! output profile

       f =(f0-f_edge)*((1-fpro)*(1-rho**p0)**p1 + fpro*(1-rho**p0a)**p1a) + f_edge
      
    END SUBROUTINE ACCOME_PARABOLIC
