...
# no_RF version 1.0 12/3/2012 (Batchelor)
# This is adaped from model_epa_ps_file_init.py version 0.3.  The only difference is that The
# fortran executable lauched is model_epa_ps_file_init.f90. As before that code generates the initial
...
# ------------------------------------------------------------------------------
    ...
    def init(self, timeStamp):
        print('model_epa_ps_file_init_no_RF.init() called')

        if (self.services == None) :
            services.error('Error in model_epa_ps_file_init_no_RF init (): No self.services')
            raise Exception('Error in model_epa_ps_file_init_no_RF init (): No self.services')
    ...
    # Get global configuration parameters
        try:
            ...
            print('model_epa_ps_file_init_no_RF: error in getting config parameters')
            services.error('model_epa_ps_file_init_no_RF: error in getting config parameters')
            raise Exception('model_epa_ps_file_init_no_RF: error in getting config parameters')
    ...
    # later
        try:
            ...
            print('model_epa_ps_file_init_no_RF init: error getting component-specific config parameters')
            services.error('model_epa_ps_file_init_no_RF: error getting component-specific\
            config parameters')
            raise Exception('model_epa_ps_file_init_no_RF: error getting model_epa-specific\
            config parameters')
    ...
    # Get input files  
     ...
     # Copy input_eqdsk_file to cur_eqdsk_file
        ...
        model_epa_bin = os.path.join(self.BIN_PATH, 'model_epa_ps_file_init_no_RF')
...
# ------------------------------------------------------------------------------
    ...
    def restart(self, timeStamp):
      print('model_epa_ps_file_init_no_RF.restart() called')
    ...
    # Get restart files listed in config file.        
      try:
            ...
            self.services.error('model_epa_ps_file_init_no_RF: error in call to get_restart_files()')
            raise Exception('model_epa_ps_file_init_no_RF: error in call to get_restart_files()')
...
# ------------------------------------------------------------------------------
    ...
    def step(self, timeStamp):
        print('model_epa_ps_file_init_no_RF.step() called')

        if (self.services == None) :
            services.error('Error in model_epa_ps_file_init_no_RF step (): No self.services')
            raise Exception('Error in model_epa_ps_file_init_no_RF step (): No self.services')
        services = self.services
...
# ------------------------------------------------------------------------------
    ...
    def checkpoint(self, timestamp=0.0):
            print('model_epa_ps_file_init_no_RF.checkpoint() called')
            services = self.services
...
# ------------------------------------------------------------------------------
    ...
    def finalize(self, timestamp=0.0):
        print('model_epa_ps_file_init_no_RF finalize() called')
