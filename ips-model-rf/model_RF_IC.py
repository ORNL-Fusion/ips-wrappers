...
# Copy current state files and input files over to working directory
        ...
        RF_IC_bin = os.path.join(self.BIN_PATH, 'model_RF_IC')

        print 'Executing ', [RF_IC_bin, cur_state_file, cur_eqdsk_file,
...
# Call model_RF_IC
        ...
        print  'subprocess.call', ([RF_IC_bin, cur_state_file, cur_eqdsk_file,
        cur_cql_file, cur_dql_file, 'STEP', timeStamp])
        if (retcode != 0):
            print 'Error executing ', RF_IC_bin
            return 1
