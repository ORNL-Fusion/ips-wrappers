...
# Copy current state files and input files over to working directory
        ...
        NB_bin = os.path.join(self.BIN_PATH, 'model_NB_2')
...
#       cur_jsdsk_file, 'STEP', timeStamp])
        task_id = services.launch_task(self.NPROC, cwd, NB_bin, cur_state_file,
            cur_eqdsk_file, cur_jsdsk_file, 'STEP', timeStamp)
