...
class gacode_init (Component):
    ...
    def step(self, timestamp):
        ...
        if simulation_mode == 'RESTART':
            ...
            ic_minfrac = '0.0'
            ic_antspec = 'None'
            ic_rfpwr = get_global_param(self, services, 'RFPWR_IC',optional=True)
            ic_minfrac = get_global_param(self, services, 'ICRF_MINFRAC',optional=True)
            ic_antspec = get_global_param(self, services, 'ICRF_SPECFILE',optional=True)
            ...
            nml_lines.append(' icrfpw = ' + ic_rfpwr + '\n')
            ...
            print('Executing ', init_bin, stdout = init_log, \
