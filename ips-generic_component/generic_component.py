...
# ------------------------------------------------------------------------------
    ...
    # instead of later
        ...
        EXECUTABLE = get_component_param(self, services, 'EXECUTABLE')
...
# files generated by the INIT component. It's reversed on STEP.
    ...
    # Get input files
        ...
        LOGFILE_NAME = get_component_param(self, services, 'LOGFILE_NAME',
            optional = True)
        COMMAND_LINE_ARGS = get_component_param(self, services, 'COMMAND_LINE_ARGS',
            optional = True)
...
# ------------------------------------------------------------------------------
    ...
    # Get component-specific configuration parameters.
        BIN_PATH = get_component_param(self, services, 'BIN_PATH')
        NPROC = get_component_param(self, services, 'NPROC')
        EXECUTABLE = get_component_param(self, services, 'EXECUTABLE', verbose=False)


    # Get component-specific optional configuration parameters.

        PRE_RUN_COPY_FILES = get_component_param(self, services,
            'PRE_RUN_COPY_FILES', optional = True, verbose = False)
        PRE_RUN_COPY_NEW_NAMES = get_component_param(self, services,
            'PRE_RUN_COPY_NEW_NAMES', optional = True, verbose = False)
        POST_RUN_COPY_FILES = get_component_param(self, services,
            'POST_RUN_COPY_FILES', optional = True, verbose = False)
        POST_RUN_COPY_NEW_NAMES = get_component_param(self, services,
            'POST_RUN_COPY_NEW_NAMES', optional = True, verbose = False)

        PRE_RUN_HELPER_CODES = get_component_param(self, services,
            'PRE_RUN_HELPER_CODES', optional = True, verbose = False)
        POST_RUN_HELPER_CODES = get_component_param(self, services,
